...
class ProductActionRepository(application: Application) {
    ...
    fun addProduct(price:String,cost:String,productName:String,productDescription:String,supplier:String,quantity:String,category: String,deliveryDate: String,expiryDate:String,unit: String,reorder: String,brand: String,vat: String) {
        ...
        if (NetworkUtils.isConnected(context)) {
            execute(price,cost,productName,productDescription,supplier,quantity,category,deliveryDate,expiryDate,unit,reorder,brand,vat)
        } else {
    ...
    fun editProduct(price:String,cost:String,productName:String,productDescription:String,supplier:String,quantity:String,category: String,brand: String,vat: String,unit: String,reorder: String,expiryDate:String,pid:String) {
        ...
        if (NetworkUtils.isConnected(context)) {
            edit(price,cost,productName,productDescription,supplier,quantity,category,brand,vat,unit,reorder,expiryDate,pid)
        } else {
    ...
    fun execute(price:String,cost:String,bname:String,dname:String,supplier:String,qty:String,categ:String,date_del:String,ex_date:String,unit:String,reorder:String,brand:String,vat:String){
        GlobalScope.launch(context = Dispatchers.Main) {
            val call = RequestService.getService(getToken()).addProduct(price,cost,bname,dname,supplier,qty,categ,date_del,ex_date,unit,reorder,brand,vat)
    ...
    fun edit(price:String,cost:String,bname:String,dname:String,supplier:String,qty:String,categ:String,brand: String,vat: String,unit:String,reorder:String,ex_date:String,pid:String){
        GlobalScope.launch(context = Dispatchers.Main) {
            val call = RequestService.getService(getToken()).editProduct(price,cost,bname,dname,supplier,qty,categ,brand,vat,unit,reorder,ex_date,pid)
            call.enqueue(object : Callback<ProductData> {
                override fun onFailure(call: Call<ProductData>?, t: Throwable?) {
