...
class RecordedExpenseAdapterB(private val type: Int, private  val context: Context, private  var modelList: List<RecordedExpense>?, private val recyclerListener: RecordedExpenseItemClick):
