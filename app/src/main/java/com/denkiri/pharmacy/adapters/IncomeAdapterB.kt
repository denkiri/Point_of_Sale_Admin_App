...
class IncomeAdapterB  (private val type: Int, private  val context: Context, private  var modelList: List<Income>?, private val recyclerListener: RecordedExpenseItemClick):
