...
class RemoveStockAdapter (private val type: Int, private  val context: Context, private  var modelList: ArrayList<Product>?, private val recyclerListener: OnCategoryItemClick): RecyclerView.Adapter<ProductViewHolder>()  {
