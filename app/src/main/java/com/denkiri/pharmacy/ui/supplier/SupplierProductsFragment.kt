...
import com.denkiri.pharmacy.ui.products.*
...
import kotlinx.android.synthetic.main.fragment_supplier_products.avi
import kotlinx.android.synthetic.main.fragment_supplier_products.empty_button
import kotlinx.android.synthetic.main.fragment_supplier_products.empty_layout
import kotlinx.android.synthetic.main.fragment_supplier_products.itemsswipetorefresh
import kotlinx.android.synthetic.main.fragment_supplier_products.main
...
class SupplierProductsFragment : Fragment() {
    ...
    private lateinit var productsViewModel: SupplierViewModel
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        return inflater.inflate(R.layout.fragment_supplier_products, container, false)
    }
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        productsViewModel = ViewModelProvider(this).get(SupplierViewModel::class.java)
    ...
    fun init() {
        if (NetworkUtils.isConnected(requireContext())) {
            productsViewModel.getSupplierProducts(supplierId.toString())
        }
    }
        ...
        productAdapter = context?.let {
            ProductAdapter(0, it, products, object : OnCategoryItemClick {
                ...
                override fun edit(pos: Int) {
                    ...
                    val fragment = EditProductFragmentB()
                ...
                override fun onClickListener(pos: Int) {
                    ...
                    //  val navController = Navigation.findNavController(requireView())
                    //  navController.navigate(R.id.nav_edit_product, bundle)
                    val fragment = IncreaseProductFragmentC()
                    fragment.arguments = bundle
                    requireActivity().supportFragmentManager.beginTransaction()
                        .replace(R.id.container, fragment)
                        .commitNow()
