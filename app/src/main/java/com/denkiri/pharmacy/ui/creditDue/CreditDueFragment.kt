...
import kotlinx.android.synthetic.main.credit_due_fragment.*
import kotlinx.android.synthetic.main.credit_due_fragment.avi
import kotlinx.android.synthetic.main.credit_due_fragment.back
import kotlinx.android.synthetic.main.credit_due_fragment.empty_button
import kotlinx.android.synthetic.main.credit_due_fragment.empty_layout
import kotlinx.android.synthetic.main.credit_due_fragment.empty_layoutB
import kotlinx.android.synthetic.main.credit_due_fragment.itemsswipetorefresh
import kotlinx.android.synthetic.main.credit_due_fragment.main
import kotlinx.android.synthetic.main.credit_due_fragment.noResults
import kotlinx.android.synthetic.main.credit_due_fragment.recyclerView
import kotlinx.android.synthetic.main.credit_due_fragment.searchView
import kotlinx.android.synthetic.main.product_expiry_fragment.*

class CreditDueFragment : Fragment() {
    lateinit var invoiceAdapter: InvoiceAdapter
    private lateinit var invoices: ArrayList<Invoice>
    internal  var number:String?=""
    companion object {
        fun newInstance() = CreditDueFragment()
    }
        ...
        invoiceAdapter = context?.let {
            InvoiceAdapter(0,it, invoices, object : OnCategoryItemClick {
                ...
                override fun edit(pos: Int) {
                    ...
                    bundle.putString( "amount" , invoices[pos].balance.toString())
                   // val navController = Navigation.findNavController(requireView())
                   // navController.navigate(R.id.nav_add_payment, bundle)
                    val fragment = AddPaymentFragmentB()
    ...
    private lateinit var viewModel: CreditDueViewModel

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        return inflater.inflate(R.layout.credit_due_fragment, container, false)
    }

    override fun onActivityCreated(savedInstanceState: Bundle?) {
        super.onActivityCreated(savedInstanceState)
        viewModel = ViewModelProvider(this).get(CreditDueViewModel::class.java)
