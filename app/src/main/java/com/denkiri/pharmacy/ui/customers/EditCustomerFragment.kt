...
import kotlinx.android.synthetic.main.fragment_edit_customer.*
...
class EditCustomerFragment : Fragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        middleName.setText((bundle?.getString("middleName")))
        lastName.setText((bundle?.getString("lastName")))
        address.setText((bundle?.getString("address")))
        contact.setText((bundle?.getString("contact")))

        editCustomer.setOnClickListener { editCustomer() }
    ...
    fun  editCustomer(){
        if (validate()) {
            customerViewModel.editCustomer(firstName.text.toString(),middleName.text.toString(),lastName.text.toString(),address.text.toString(),contact.text.toString(),customerId.toString(),customerCode.toString(),customerName.toString())
        }
