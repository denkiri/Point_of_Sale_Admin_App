...
class BrandChartFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_brand_chart, container, false)
    }
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        pageUrl=NetworkUtils.url()+"charts/pages/brandChart.php"
        loadChart()
