...
import com.denkiri.pharmacy.ui.main.TotalIncomeFragment
...
import kotlinx.android.synthetic.main.fragment_edit_recorded_income_b.*
import java.util.*
import kotlin.collections.ArrayList


class EditRecordedIncomeFragmentB : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_edit_recorded_income_b, container, false)
    }
    ...
    companion object {
        ...
        @JvmStatic
        fun newInstance() =
            EditRecordedIncomeFragmentB().apply {
