...
import com.denkiri.pharmacy.adapters.IncomeAdapterB
...
import com.denkiri.pharmacy.ui.main.EditRecordedIncomeFragment
...
import kotlinx.android.synthetic.main.fragment_day_income_report.*
import kotlinx.android.synthetic.main.fragment_day_income_report.avi
import kotlinx.android.synthetic.main.fragment_day_income_report.empty_button
import kotlinx.android.synthetic.main.fragment_day_income_report.empty_layout
import kotlinx.android.synthetic.main.fragment_day_income_report.itemsswipetorefresh
import kotlinx.android.synthetic.main.fragment_day_income_report.main
import kotlinx.android.synthetic.main.fragment_day_income_report.productsTotal
import kotlinx.android.synthetic.main.fragment_day_income_report.recyclerView
 ...
 * Use the [DayIncomeReportFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class DayIncomeReportFragment : Fragment() {
    lateinit var datePicker: DatePickerHelper
    private lateinit var viewModel: ExpenseViewModel
    lateinit var incomeAdapter: IncomeAdapterB
    private lateinit var income: ArrayList<Income>
    private fun initView(){
        income = ArrayList()
        incomeAdapter = context?.let {
            IncomeAdapterB(0, it, income, object : RecordedExpenseItemClick {
                ...
                override fun edit(pos: Int) {
                    ...
                    val fragment = EditRecordedIncomeFragmentB()
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_day_income_report, container, false)
    }
    ...
    private fun setUpIncome(income: ArrayList<Income>) {
        this.income = income
        productsTotal.text= income.size.toString()
    ...
    companion object {
         ...
         * @return A new instance of fragment DayIncomeReportFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance() =
            DayIncomeReportFragment().apply {
