 ...
 * Use the [PaymentModeFragment.newInstance] factory method to
...
class PaymentModeFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment PaymentModeFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance() =
            PaymentModeFragment().apply {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        pageUrl=NetworkUtils.url()+"charts/pages/charts.php"
        loadChart()
