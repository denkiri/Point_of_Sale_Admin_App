...
import kotlinx.android.synthetic.main.fragment_vat_chart.*
/**
 * A simple [Fragment] subclass.
 * Use the [VatChartFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class VatChartFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        return inflater.inflate(R.layout.fragment_vat_chart, container, false)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment VatChartFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
                VatChartFragment().apply {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        pageUrl=NetworkUtils.url()+"charts/pages/vat.php"
        loadChart()
