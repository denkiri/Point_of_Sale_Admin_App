 ...
 * Use the [AddProductFragmentB.newInstance] factory method to
 * create an instance of this fragment.
 */
class AddProductFragmentB : Fragment() {
    ...
    fun addProduct(){
        if (validate()){
            productsViewModel.addProduct(price.text.toString(),cost.text.toString(),productName.text.toString(),description.text.toString(),supplier.toString(),qty.text.toString(),category.toString(),delivery.toString(),delivery.toString(),unit.toString(),reorder.text.toString(),brand.toString(),vat.text.toString())
        }
    }
        ...
        categoryAdapter = context?.let {
            CategoryItemAdapter(0, it, categories, object : OnCategoryClick {
                ...
                override fun selected(pos: Int) {
                    (categories as ArrayList<Category>)[pos].categoryName?.let { it1 -> Toasty.success(requireContext(), it1, Toast.LENGTH_SHORT, true).show() }
                    category=(categories as ArrayList<Category>)[pos].categoryName.toString()
                    categ.text=(categories as ArrayList<Category>)[pos].categoryName.toString()
                }
    ...
    private fun initViewSupplier(){
        ...
        supplierAdapter = context?.let {
            SupplierItemAdapter(0, it, suppliers, object : OnSupplierClick {
                ...
                override fun selected(pos: Int) {
                    (suppliers as ArrayList<Supplier>)[pos].suplierName?.let { it1 -> Toasty.success(requireContext(), it1, Toast.LENGTH_SHORT, true).show() }
