...
import kotlinx.android.synthetic.main.fragment_edit_product_c.*
import java.util.*
import kotlin.collections.ArrayList
class EditProductFragmentC : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        return inflater.inflate(R.layout.fragment_edit_product_c, container, false)
    }
    fun init() {
